  ...
  return (
    <>
      ...
      <div className="thumbnail-container">
        <div className="margin-bottom-110">
          <Thumbnail
          ...
          <div className="sd-description-box">
            ...
            <p className="description">
              This reading will provide insight into the person on your mind and
              how they truly feel about you.
            </p>
          </div>
        </div>
        <div className="margin-bottom-130">
          <Thumbnail
          ...
          <div className="sd-description-box">
            ...
            <hr className="hr-3"></hr>
            <p className="description">
              This reading will provide insight into a situation with someone
              you are no longer in contact with and whether or not this person
        ...
        <div className="margin-bottom-110">
          ...
          <div className="sd-description-box">
            ...
            <hr className="hr-3"></hr>
            <p className="description">
              This reading will describe who is currently thinking about you and
              why you're on this person's mind.
            </p>
          </div>
        </div>
